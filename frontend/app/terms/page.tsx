      ...
      <div className="pt-32 pb-20 bg-white dark:bg-[#0a0f1e]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-slate-600 dark:text-slate-400">
            {[
              { title: '1. Acceptance of Terms', content: 'By accessing and using the AirX Solution website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, please do not use our services.' },
              { title: '2. Services', content: 'AirX Solution provides web development, Shopify development, UI/UX design, and related digital services. The specific scope, timeline, and deliverables for each project are detailed in separate project agreements or statements of work.' },
              ...
              { title: '4. Intellectual Property', content: 'Upon receipt of full payment, the client receives full ownership of all custom-developed work, including design files and source code. AirX Solution retains the right to display the project in its portfolio unless otherwise agreed in writing. Third-party assets, plugins, and themes are subject to their respective licenses.' },
              ...
              { title: '10. Termination', content: 'Either party may terminate a project with 14 days written notice. Upon termination, the client will pay for all work completed to date. AirX Solution will provide all completed work product upon receipt of final payment.' },
              ...
              { title: '12. Contact', content: 'For questions about these Terms & Conditions, contact us at legal@airxsolution.com or write to: AirX Solution, 123 Digital Avenue, Tech City, TC 10001.' },
            ].map(section => (
