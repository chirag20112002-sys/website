              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 sticky top-4">
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="text-sm text-slate-700">{selected.company || '—'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-700">{selected.service || '—'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Budget</p>
                      <p className="text-sm text-slate-700">{selected.budget || '—'}</p>
                    </div>
                  </div>
                  <div>
                ...
                <div className="space-y-2">
                  <a
                    ...
                    className="flex items-center gap-2 w-full py-2.5 rounded-xl border border-indigo-500 text-violet-600 hover:bg-indigo-900/20 text-sm font-medium justify-center transition-colors"
                  >
                  ...
                  {selected.status !== 'closed' && (
                    <button
                      ...
                      className="flex items-center gap-2 w-full py-2.5 rounded-xl border border-gray-200 text-slate-400 hover:bg-gray-100 text-sm font-medium justify-center transition-colors"
                    >
                      Close Inquiry
                    </button>
                  )}
